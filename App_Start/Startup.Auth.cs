using Elicit.Web.Core.Security.PlainText;
using Microsoft.AspNet.Identity;
using Microsoft.Owin;
using Microsoft.Owin.Security.Cookies;
using Owin;
using Elicit.Web.Core.Security;
using System;
using System.Configuration;
using System.Web;

namespace Elicit.App_Start
{
    public partial class Startup
    {
        ...
        /*This one method illustrates how one would tell if a given request
